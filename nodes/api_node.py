...
class FluxPro11(BaseFlux):
    ...
    def generate_image(self, prompt, width, height, prompt_upsampling, safety_tolerance, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxDev(BaseFlux):
    ...
    def generate_image(self, prompt, width, height, steps, prompt_upsampling, safety_tolerance, guidance, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxDevRedux(BaseFlux):
    ...
    def generate_image(self, prompt, image_prompt, width, height, steps, prompt_upsampling, safety_tolerance, guidance, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxPro(BaseFlux):
    ...
    def generate_image(self, prompt, width, height, steps, prompt_upsampling, safety_tolerance, guidance, interval, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxPro11Ultra(BaseFlux):
    ...
    def generate_image(self, prompt, aspect_ratio, safety_tolerance, output_format, raw, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxProCanny(BaseFlux):
    ...
    def generate_image(self, prompt, control_image, prompt_upsampling, steps, guidance, safety_tolerance, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxPro11Redux(BaseFlux):
    ...
    def generate_image(self, prompt, image_prompt, width, height, prompt_upsampling, safety_tolerance, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxPro11UltraRedux(BaseFlux):
    ...
    def generate_image(self, prompt, image_prompt, image_prompt_strength, aspect_ratio, safety_tolerance, output_format, raw, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
...
class FluxKontextPro(BaseFlux):
    ...
    def generate_image(self, prompt, input_image, aspect_ratio, prompt_upsampling, safety_tolerance, output_format, seed, config=None):
        if config is None:
            config = ConfigLoader()
        arguments = {
            "prompt": prompt,
